...
# get number of tasks
seq_ids = list(sfu_config.seq_cfg_ai.keys())
num_seqs = len(seq_ids)
num_tasks = num_seqs * len(sfu_config.seq_cfg_ai[seq_ids[0]])
...
# init environment
ini_path = os.path.join('output', 'working_dir', 'SFU_AI_ini')
...
quality = sfu_config.seq_cfg_ai[seq_id][qp_idx][0]
