...
#CUDA_VISIBLE_DEVICES=1 python $dec_exe --output_dir $output_dir/QP_27 $input_dir/QP_27 & \
#CUDA_VISIBLE_DEVICES=2 python $dec_exe --output_dir $output_dir/QP_32 $input_dir/QP_32 & \
#CUDA_VISIBLE_DEVICES=3 python $dec_exe --output_dir $output_dir/QP_37 $input_dir/QP_37 & \
#CUDA_VISIBLE_DEVICES=4 python $dec_exe --output_dir $output_dir/QP_42 $input_dir/QP_42 & \
#CUDA_VISIBLE_DEVICES=5 python $dec_exe --output_dir $output_dir/QP_47 $input_dir/QP_47 &
