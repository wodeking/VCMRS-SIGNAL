...
from .Utils.bound_ops import LowerBound
import ans
...
class EntropyBottleneck(EntropyModel):
    ...
    *tensorflow/compression*. See the original paper and the `tensorflow
    ...
    def __init__(self,
        ...
        #self._factors = nn.ParameterList() # alpha
    ...
    def update(self, force=False):
        ...
        samples = torch.arange(max_length).to(self.quantiles.device)
    ...
    def forward(self, x):
        ...
        entropy = -likelihood.log().sum() / 0.69314718 # base 2
