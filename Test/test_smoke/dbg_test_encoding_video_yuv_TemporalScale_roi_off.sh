...
python ./tools/check_psnr.py --f1 $recon_fname --f1_bitdepth 10 --f2 $fname --f2_bitdepth 10 -t 8
...
python ./tools/check_psnr.py --f1 $dec_dir/$(basename $fname .yuv)  --f2 $input_dir  -t 8
